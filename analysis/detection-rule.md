...
SSH Brute Force Detection – Excessive Authentication Attempts
...
Parameter	Value
Attempts	> 5
Time Window	Analyst-defined (e.g. 5–10 minutes)
Scope	Per Source IP
...
Validate source IP behavior in Splunk

Check for successful authentication events
